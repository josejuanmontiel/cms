    	        			...
    	        			<div>
    	        				...
    	        				<div class="portletBody">
    	        					<div class="portletContent odd">
										<a class="navItem navRootItem" href="home/home_detalle_detail_1.html"><span class="navItemText">Home</span></a>
										<xsl:call-template name="menu_left_default_other_pub"/>
						            </div>
						        </div>
						    </div>
						</div>
				...
				<td id="portal-column-content">
					<div id="content" class="">
						<div class="documentContent" id="region-content">
							...
							<div>
								<div>
									<xsl:for-each select="ROW[@publication_type='Translations and Publications in Review']">
