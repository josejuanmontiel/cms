				...
				<td id="portal-column-content">
					<div id="content" class="">
						<div class="documentContent" id="region-content">
							...
							<div>
								<div>
									<a href="insertContent.jsp?table_to_insert={$table}">Insertar nuevo perfil</a>
									<br />
									<xsl:for-each select="ROW">
										<xsl:variable name='pos' select='position()' />

										<h1 class="documentFirstHeading"><img src="../../portals/francescoluti/img/flag/flag-{@lang}.gif" /><xsl:value-of select="@title"/><input type="hidden" name="{name()}" value="{@title}"/></h1>
