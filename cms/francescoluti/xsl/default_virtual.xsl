    	        			...
    	        			<div>
    	        				...
    	        				<div class="portletBody">
    	        					<div class="portletContent odd">
										<a class="navItem navRootItem currentNavItem" href="home/home_detalle_detail_1.html"><span class="navItemText">Home</span></a>
				...
				<td id="portal-column-content">
					<div id="content" class="">
						<div class="documentContent" id="region-content">
							...
							<DIV>
								<xsl:for-each select="VTABLE[@VNAME='francescoluti_home_detalle']/ROW[@id=1]">
                                                                <h1 class="documentFirstHeading"><xsl:value-of select="@adicional"/></h1>
 									...
 									<table>
										...
										<tr>
											...
											<td id="portal-column-content">
												...
												<div>
													<a href="home/home_detalle_detail_1.html"><img alt="Italiano" src="img/flag/flag-it.gif"/></a>
													<a href="home/home_detalle_detail_2.html"><img alt="Ingles" src="img/flag/flag-en.gif"/></a>
&#60;&#33;&#45;&#45;
													<a href="home/home_detalle_detail_3.html"><img alt="Espanol" src="img/flag/flag-es.gif"/></a>
&#45;&#45;&#62;
												</div>
											</td>
										</tr>
