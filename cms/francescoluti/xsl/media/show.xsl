				...
				<td id="portal-column-content">
					<div id="content" class="">
						<div class="documentContent" id="region-content">
							...
							<div>
								<h1 class="documentFirstHeading">COMMENTS IN THE MEDIA</h1>
							</div>
							...
							<xsl:for-each select="ROW">
								...
								<xsl:if test="@menu='' and @submenu=''">
									...
									<form action="DeleteContent" name="{@id}" id="{@id}" method="post">
							...
							<a href="insertContent.jsp?table_to_insert={$table}&amp;menu=&amp;submenu=">Insertar AQUI</a>

							<p></p><h1>About Millepiedi</h1>

							<p></p><h2>Millepiedi presentato in Televisione</h2>

							<xsl:for-each select="ROW">
								<xsl:variable name='pos' select='position()' />
								<xsl:if test="@menu='About Millepiedi' and @submenu='Millepiedi presentato in Televisione'">
									<p>
										<xsl:choose>
									        <xsl:when test="@link!=''">
												<a href="{@link}"><xsl:value-of select="@text" /></a>
							...
							<a href="insertContent.jsp?table_to_insert={$table}&amp;menu=About%20Millepiedi&amp;submenu=Millepiedi%20presentato%20in%20Televisione">Insertar AQUI</a>

							<p></p><h2>Millepiedi recensioni</h2>

							<xsl:for-each select="ROW">
								<xsl:variable name='pos' select='position()' />
								<xsl:if test="@menu='About Millepiedi' and @submenu='Millepiedi recensioni'">
									<p>
										<xsl:choose>
									        <xsl:when test="@link!=''">
												<a href="{@link}"><xsl:value-of select="@text" /></a>
							...
							<a href="insertContent.jsp?table_to_insert={$table}&amp;menu=About%20Millepiedi&amp;submenu=Millepiedi%20recensioni">Insertar AQUI</a>

							<p></p><h2>Millepiedi presentazioni</h2>

							<xsl:for-each select="ROW">
								<xsl:variable name='pos' select='position()' />
								<xsl:if test="@menu='About Millepiedi' and @submenu='Millepiedi presentazioni'">
									<p>
										<xsl:choose>
									        <xsl:when test="@link!=''">
												<a href="{@link}"><xsl:value-of select="@text" /></a>
							...
							<a href="insertContent.jsp?table_to_insert={$table}&amp;menu=About%20Millepiedi&amp;submenu=Millepiedi%20presentazioni">Insertar AQUI</a>
